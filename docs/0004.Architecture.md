...
Below is the text-based diagram using **PlantUML** + **AWS Icons** (via awslabs/aws-icons-for-plantuml). Paste this into a PlantUML renderer to visualize.
...
!includeurl AWSPuml/EndUserComputing/QuickSight.puml
